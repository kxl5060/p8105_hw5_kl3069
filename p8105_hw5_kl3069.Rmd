...
* **Some comments on plot**: As can be seen from the above plot, as the true value of mu increases from 0 to 6, the proportion of times the null was rejected **(p-value less than 0.05)** or the power of the test increases. Thus, there is a positive relationship between effect size and power. 
