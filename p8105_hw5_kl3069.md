...
<img src="p8105_hw5_kl3069_files/figure-gfm/unnamed-chunk-11-1.png" width="90%" />
  ...
  - **Some comments on plot**: As can be seen from the above plot, as
    the true value of mu increases from 1 to 6, the proportion of times
    the null was rejected **(p-value less than 0.05)** or the power of
    the test increases. Thus, there is a positive relationship between
